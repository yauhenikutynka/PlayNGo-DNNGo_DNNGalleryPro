<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_Manager.aspx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Index_Manager" %>
...
<body id="Body" runat="server" >
    ...
    <link rel="stylesheet" href="<%=ModulePath %>Resource/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css?cdv=<%=CrmVersion %>">
    ...
    <script src="<%=ModulePath %>Resource/js/moment.min.js?cdv=<%=CrmVersion %>"></script>
    ...
    <script src="<%=ModulePath %>Resource/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js?cdv=<%=CrmVersion %>"></script>
...
<div class="navbar navbar-inverse navbar-fixed-top"> 
  ...
  <div class="container">
    ...
    <div class="navbar-tools hidden-xs"> 
        ...
        <asp:HyperLink ID="hlBuyIt" resourcekey="hlBuyIt" runat="server" Target="_blank" CssClass="btn btn-teal" NavigateUrl="http://www.dnngo.net/DNNStore/tabid/58/ProductID/1643/Default.aspx" Text="<i class='fa clip-cart'></i> | Buy It" ToolTip="Buy It"></asp:HyperLink>
        <asp:HyperLink ID="hlDocumentation" resourcekey="hlDocumentation" runat="server" Target="_blank" CssClass="btn btn-teal" NavigateUrl="http://www.dnngo.net/doc/DNNGalleryPro/index.html" Text="<i class='fa clip-book'></i> | Documentation" ToolTip="Documentation"></asp:HyperLink>
	...
	<!-- start: FOOTER -->
		<div class="footer clearfix">
			<div class="footer-inner">
				2013 &copy; DNNGalleryPro by <a href="http://www.dnngo.net/" target="_blank">dnngo.net</a>.
			</div>
...
<script id="scriptImageEditor" type="text/x-jquery-tmpl">
     {{if IsPicture}}
        ...
        {{else}}
            <div><a href="${FileUrl}" target="_blank" title="${FileName}">${FileName}</a></div>
        {{/if}}
</script>
<!-- Modal start -->
