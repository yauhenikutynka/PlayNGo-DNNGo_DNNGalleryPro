<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Library.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Manager_Library" %>
      <!-- start: PAGE HEADER -->
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            ...
            <asp:HyperLink ID="hlSynchronizeFiles" runat="server" CssClass="btn btn-xs btn-green"  Text="<i class='fa fa-cloud-upload'></i> Synchronize Files " resourcekey="hlSynchronizeFiles" ></asp:HyperLink>
