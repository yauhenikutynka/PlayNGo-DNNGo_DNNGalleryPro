...
{
    public partial class Setting_Library_Synchronize : BaseModule
    {
        ...
        {
            String WebPath = String.Format("{0}DNNGalleryPro/SynchronizeFiles/", PortalSettings.HomeDirectory);
        ...
        public void BindFileList(DirectoryInfo FolderPath)
        {
            ...
            System.IO.FileInfo[] SynchronizeFiles = FolderPath.GetFiles();
            ...
            if (SynchronizeFiles != null && SynchronizeFiles.Length > 0)
            {
                ...
                {
                    System.IO.FileInfo SynchronizeFile = SynchronizeFiles[i];

                    String FileWebPath = String.Format("DNNGalleryPro/SynchronizeFiles/{0}", SynchronizeFile.Name);
        ...
        public Int32 SynchronizeAllFiles()
        {
            ...
            List<System.IO.FileInfo> SynchronizeFiles = Common.Split<System.IO.FileInfo>(dir.GetFiles(), 1, int.MaxValue);

            foreach (System.IO.FileInfo SynchronizeFile in SynchronizeFiles)
            {
