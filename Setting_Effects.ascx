<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Effects.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Setting_Effects" %>
...
<div class="row">
    <div class="col-sm-12">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="background: none; padding: 0px; border: none;">
                                               ...
                                               <asp:Literal runat="server" ID="LiLayers"></asp:Literal>
                                               <asp:Literal runat="server" ID="LiGroups"></asp:Literal>
                                               <asp:Literal runat="server" ID="liDownloads"></asp:Literal>
                                               <asp:Literal runat="server" ID="liAjax"></asp:Literal>
                    ...
                    <div class="full_version_title" id="full_version_title" runat="server" visible="false">
                        ...
                        <br />
                        <%=ViewTitle("lblFullVersionContent", "If you need more effects,Please purchase the <a href='http://www.dnngo.net/DNNStore/tabid/58/CategoryID/105/List/0/Level/a/ProductID/468/Default.aspx' target='_blank'>DNNGo.DNNGalleryPro</a> to own all amazing effects!")%>
                    </div>
