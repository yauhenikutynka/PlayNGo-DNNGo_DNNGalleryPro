...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class Setting_Effects : BaseModule
    {
        ...
        private void BindDataToPage()
        {
            ...
            //如果模块名称不是DNNGo.DNNGalleryPro,则默认只加载第一个主题
            if (!(BaseModuleName.IndexOf("DNNGo.DNNGalleryPro", StringComparison.CurrentCultureIgnoreCase) >= 0))
            {
        ...
        protected void btnApply_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                UpdateModuleSetting("DNNGalleryPro_EffectName", btnApply.CommandArgument);
