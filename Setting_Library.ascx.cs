...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class Manager_Library : BaseModule
    {
        ...
        private void BindDataList()
        {
            ...
            {
                qp.Orderfld = DNNGo_DNNGalleryPro_Files._.ID;
            }
            ...
            List<DNNGo_DNNGalleryPro_Files> Comments = DNNGo_DNNGalleryPro_Files.FindAll(qp, out RecordCount);
            ...
            hlFileMateAll.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Files.FindCountByType(ByPortalID, -1), ViewResourceText("hlFileMateAll", "All"));
            hlFileMateImage.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Files.FindCountByType(ByPortalID, (Int32)EnumFileMate.Image), ViewResourceText("hlFileMateImage", "Image"));
            hlFileMateZip.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Files.FindCountByType(ByPortalID, (Int32)EnumFileMate.Zip), ViewResourceText("hlFileMateZip", "Zip"));
            hlFileMateVideo.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Files.FindCountByType(ByPortalID, (Int32)EnumFileMate.Video), ViewResourceText("hlFileMateVideo", "Video"));
            hlFileMateDoc.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Files.FindCountByType(ByPortalID, (Int32)EnumFileMate.Doc), ViewResourceText("hlFileMateDoc", "Doc"));
            ...
            BindGridViewEmpty<DNNGo_DNNGalleryPro_Files>(gvCommentList, new DNNGo_DNNGalleryPro_Files());
        }
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            if (FileType >= 0)
            {
                Where = DNNGo_DNNGalleryPro_Files.ByType(Where, FileType);
            }
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(DNNGo_DNNGalleryPro_Files._.Name, HttpUtility.UrlDecode(Search_Title), SearchType.Like));
            }
        ...
        protected void gvCommentList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                //还原出数据
                DNNGo_DNNGalleryPro_Files Media = e.Row.DataItem as DNNGo_DNNGalleryPro_Files;
        ...
        protected void btnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnRemove != null && !String.IsNullOrEmpty(btnRemove.CommandArgument))
                {
                    ...
                    DNNGo_DNNGalleryPro_Files Multimedia = DNNGo_DNNGalleryPro_Files.FindByKeyForEdit(btnRemove.CommandArgument);
