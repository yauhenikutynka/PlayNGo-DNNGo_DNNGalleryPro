<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_ManagerLists.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Setting_ManagerLists" %>
 <!-- start: PAGE HEADER -->
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa clip-list-4"></i> <%=ViewResourceText("Header_Title", "All Sliders")%>
      ...
      <div class="row">
        <div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-8 ">
                  ...
                  <div class="btn-group">
                    ...
                    <asp:HyperLink runat="server" ID="hlActivatedArticle" CssClass="btn btn-default" Text="Activated"></asp:HyperLink>  
                    <asp:HyperLink runat="server" ID="hlHiddenArticle" CssClass="btn btn-default" Text="Hidden"></asp:HyperLink>   
          ...
          <div class="form-group"  id="divGroupFilter" runat="server" visible="false">
            <div class="row">
              <div class="col-sm-8 ">
               
                  <div class="btn-group">
         
                    <asp:Literal ID="liGroups" runat="server"></asp:Literal>
            ...
            <div class="row">
              <div class="col-sm-9">
                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control form_default">
                    ...
                    <asp:ListItem Value="1" Text="Activated" resourcekey="ddlStatus_Activated"></asp:ListItem>
                    <asp:ListItem Value="0" Text="Hidden" resourcekey="ddlStatus_Hidden"></asp:ListItem>
          ...
          <div class="form-group">
            <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvArticleList_RowDataBound" OnRowCreated="gvArticleList_RowCreated" OnSorting="gvArticleList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                             ...
                             <asp:BoundField HeaderText="Title"  Visible="false" />
                             <asp:TemplateField HeaderText="Picture" HeaderStyle-Width="110" Visible="false">
                                <ItemTemplate>
                                     <asp:Image ID="imgPicture" runat="server" style="width:100px;" CssClass="img-responsive" />  
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="ID" HeaderText="Group" Visible="false"/> 
                            ...
                            <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status"/> 
                             ...
                             <asp:TemplateField HeaderText="Sort" SortExpression="Sort"  HeaderStyle-CssClass="hidden-xs" ItemStyle-CssClass="hidden-xs" >
                                <ItemTemplate>
