<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Library_Synchronize.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Setting_Library_Synchronize" %>
        ...
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa fa-cloud-upload"></i> <%=ViewResourceText("Header_Title", "Synchronize Files")%> 
                <asp:HyperLink ID="hlReturnLibrary" runat="server" CssClass="btn btn-xs btn-default"  Text="<i class='fa fa-mail-reply-all'></i> Return to library " resourcekey="hlReturnLibrary" ></asp:HyperLink>
            </h1>
          </div>
