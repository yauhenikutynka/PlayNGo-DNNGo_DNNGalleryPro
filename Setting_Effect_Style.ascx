<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Effect_Style.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Setting_Effect_Style" %>
<!-- start: PAGE HEADER -->
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa clip-file-css"></i> <%=ViewResourceText("Header_Title", "Effect Style")%></h1>
          </div>
