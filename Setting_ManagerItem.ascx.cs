...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class Setting_ManagerItem : BaseModule
    {
        ...
        private DNNGo_DNNGalleryPro_Slider _SliderItem;
        /// <Description>
        /// 文章项
        /// </Description>
        public DNNGo_DNNGalleryPro_Slider SliderItem
        {
            get
            {
                ...
                {
                    if (SliderID > 0)
                        _SliderItem = DNNGo_DNNGalleryPro_Slider.FindByKeyForEdit(SliderID);
                    else
                        _SliderItem = new DNNGo_DNNGalleryPro_Slider();
                }
                return _SliderItem;
            }
        }
        ...
        private void BindDataItem()
        {
            ...
            if (Article == null) Article = new DNNGo_DNNGalleryPro_Slider();
