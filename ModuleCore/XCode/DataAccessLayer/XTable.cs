...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    /// 表构架
    /// </summary>
    [DebuggerDisplay("ID={ID} Name={Name} Readme={Readme}")]
    [Serializable]
    public class XTable
    {
        #region 属性
        ...
        private XField[] _Fields;
        /// <summary>
        /// 字段构架集合。首次使用时才加载。
        /// </summary>
        [XmlArray]
        public XField[] Fields { get { return _Fields; } set { _Fields = value; } }
        #endregion
        ...
        public override bool Equals(object obj)
        {
            ...
            if (this.Readme != table.Readme) return false;
