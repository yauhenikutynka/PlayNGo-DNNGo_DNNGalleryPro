...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public class Entity<TEntity> : ICloneable where TEntity : Entity<TEntity>, new()
    {
        ...
        public static class Meta
        {
            ...
            /// 实体链接名
            /// </summary>
            public static String ConnName { get { return Config.ConnName(ThisType); } }

            /// <summary>
            /// 表名
            /// </summary>
            public static String TableName { get { return Config.TableName(ThisType); } }

            /// <summary>
            /// 所有数据属性
            /// </summary>
            public static FieldItem[] AllFields { get { return Config.AllFields(ThisType); } }

            /// <summary>
            /// 所有绑定到数据表的属性
            /// </summary>
            public static FieldItem[] Fields { get { return Config.Fields(ThisType); } }
            ...
            /// 唯一键
            /// </summary>
            public static FieldItem[] Uniques { get { return Config.Unique(ThisType); } }
        ...
        {
            return LoadData(Meta.Query(Config.SQL(Meta.ThisType, DataObjectMethodType.Fill)));
        }
        ...
        {
            return Meta.QueryCount(Config.SQL(Meta.ThisType, DataObjectMethodType.Fill));
        }
        ...
        protected static String SqlDataFormat(Object obj, FieldItem field)
        {
            ...
            else if (typeName.Contains("DateTime"))
            {
                ...
                dt = xCalendar.Process(dt);//处理波斯历的问题
