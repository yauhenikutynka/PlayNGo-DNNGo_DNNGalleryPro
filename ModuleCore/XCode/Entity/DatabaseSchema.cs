...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public class DatabaseSchema
    {
        ...
        /// 表
        /// </summary>
        public BindTableAttribute Table { get { return Config.Table(EntityType); } }
        ...
        internal List<FieldItem> Fields
        {
            get
            {
                if (_Fields == null)
                {
                    List<FieldItem> list = new List<FieldItem>(Config.Fields(EntityType));
        ...
        /// 表名
        /// </summary>
        public String TableName { get { return Config.TableName(EntityType); } }
        #endregion
        #endregion
