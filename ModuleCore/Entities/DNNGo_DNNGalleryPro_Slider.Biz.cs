...
namespace DNNGo.Modules.DNNGalleryPro
{
	...
	/// 画廊内容
	/// </summary>
	public partial class DNNGo_DNNGalleryPro_Slider : Entity<DNNGo_DNNGalleryPro_Slider>
	{
        #region 对象操作
        ...
        private List<DNNGo_DNNGalleryPro_Layer> _LayerList = new List<DNNGo_DNNGalleryPro_Layer>();
        /// <summary>
        /// ceng列表
        /// </summary>
        public List<DNNGo_DNNGalleryPro_Layer> LayerList
        {
            get
            {
                if (!(_LayerList != null && _LayerList.Count > 0) && ID > 0)
                {
                    _LayerList = DNNGo_DNNGalleryPro_Layer.FindAllBySliderID(ID);
                }
                return _LayerList;
            }
        }

        private List<DNNGo_DNNGalleryPro_Group> _GroupList = new List<DNNGo_DNNGalleryPro_Group>();
        /// <summary>
        /// 分组列表
        /// </summary>
        public List<DNNGo_DNNGalleryPro_Group> GroupList
        {
            get
            {
                if (!(_GroupList != null && _GroupList.Count > 0) && ID > 0)
                {
                    _GroupList = DNNGo_DNNGalleryPro_Group.FindAllBySliderID(ID);
                }
                return _GroupList;
            }
        }
        ...
        /// <returns></returns>
        public static List<DNNGo_DNNGalleryPro_Slider> FindAllByModuleID(object ModuleID,Int32 Status = -1)
        {
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_DNNGalleryPro_Slider FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_DNNGalleryPro_Slider> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        public static void MoveField(DNNGo_DNNGalleryPro_Slider objTab, EnumMoveType type, object ModuleID,Int32 Status)
        {
            List<DNNGo_DNNGalleryPro_Slider> siblingTabs = FindAllByModuleID(ModuleID, Status); 
            ...
            switch (type)
            {
                case EnumMoveType.Up:
                    ...
                    if (tabIndex > 0)
                    {
                        DNNGo_DNNGalleryPro_Slider swapTab = siblingTabs[tabIndex - 1];
        ...
        private static void SwapAdjacentTabs(DNNGo_DNNGalleryPro_Slider firstTab, DNNGo_DNNGalleryPro_Slider secondTab)
        {
            firstTab.Sort -= 2;
            firstTab.Update();
            secondTab.Sort += 2;
        ...
        private static void UpdateTabOrder(List<DNNGo_DNNGalleryPro_Slider> tabs, int increment)
        {
            int tabOrder = 1;
            for (int index = 0; index <= tabs.Count - 1; index++)
            {
                DNNGo_DNNGalleryPro_Slider objTab = tabs[index];
        ...
        private static void UpdateTabOrder(List<DNNGo_DNNGalleryPro_Slider> tabs, int startIndex, int endIndex, int increment)
        {
        ...
        private static int GetIndexOfTab(DNNGo_DNNGalleryPro_Slider objTab, List<DNNGo_DNNGalleryPro_Slider> tabs)
        {
