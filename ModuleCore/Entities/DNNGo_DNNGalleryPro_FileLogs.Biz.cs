...
namespace DNNGo.Modules.DNNGalleryPro
{
	...
	/// 文件下载日志
	/// </summary>
	public partial class DNNGo_DNNGalleryPro_FileLogs : Entity<DNNGo_DNNGalleryPro_FileLogs>
	{
		#region 对象操作
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个文件下载日志实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">日志编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_DNNGalleryPro_FileLogs FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_DNNGalleryPro_FileLogs entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_DNNGalleryPro_FileLogs();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_DNNGalleryPro_FileLogs FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<DNNGo_DNNGalleryPro_FileLogs> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
