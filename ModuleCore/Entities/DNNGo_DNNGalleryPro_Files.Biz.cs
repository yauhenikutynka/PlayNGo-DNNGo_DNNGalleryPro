...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    {
        #region 对象操作
        static DNNGo_DNNGalleryPro_Files()
        {
            // 用于引发基类的静态构造函数，所有层次的泛型实体类都应该有一个
            DNNGo_DNNGalleryPro_Files entity = new DNNGo_DNNGalleryPro_Files();
        }
        ...
        public static DNNGo_DNNGalleryPro_Files FindByID(Int32 id)
        {
            return Find(_.ID, id);
        }
