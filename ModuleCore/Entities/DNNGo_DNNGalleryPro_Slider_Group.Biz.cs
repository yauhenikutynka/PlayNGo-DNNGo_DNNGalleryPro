...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public partial class DNNGo_DNNGalleryPro_Slider_Group : Entity<DNNGo_DNNGalleryPro_Slider_Group> 
    {
        #region 对象操作
        static DNNGo_DNNGalleryPro_Slider_Group()
        {
            // 用于引发基类的静态构造函数，所有层次的泛型实体类都应该有一个
            DNNGo_DNNGalleryPro_Slider_Group entity = new DNNGo_DNNGalleryPro_Slider_Group();
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}分类文章关系数据……", typeof(DNNGo_DNNGalleryPro_Slider_Group).Name);

        //    DNNGo_DNNGalleryPro_Slider_Group user = new DNNGo_DNNGalleryPro_Slider_Group();
        //    user.Name = "admin";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}分类文章关系数据！", typeof(DNNGo_DNNGalleryPro_Slider_Group).Name);
        //}
        ...
        {
            DNNGo_DNNGalleryPro_Slider_Group ArticleItem = new DNNGo_DNNGalleryPro_Slider_Group();
        ...
        public static DNNGo_DNNGalleryPro_Slider_Group FindByID(Int32 id)
        {
            return Find(_.ID, id);
        }
        ...
        /// <returns></returns>
        public static List<DNNGo_DNNGalleryPro_Slider_Group> FindAllBySliderID(Int32 SliderID)
        {
            return FindAll(_.SliderID, SliderID);
        }

        public static List<DNNGo_DNNGalleryPro_Slider_Group> FindAllByArticleID(int ArticleID)
        {




            return Entity<DNNGo_DNNGalleryPro_Slider_Group>.FindAll("SliderID", ArticleID);
        }
        ...
        public static Int32 Update(Int32 ArticleID, List<String> CategoryIDList)
        {
            ...
            //查出当前文章关联的所有分类数据
            List<DNNGo_DNNGalleryPro_Slider_Group> CategoryList = FindAllByArticleID(ArticleID);


            //制造临时变量
            String[] tempCategoryIDList = CategoryIDList.ToArray();
            CategoryIDList.CopyTo(tempCategoryIDList);
            DNNGo_DNNGalleryPro_Slider_Group[] tempCategoryList = CategoryList.ToArray(); CategoryList.CopyTo(tempCategoryList);

            foreach (String CategoryID in tempCategoryIDList)
            {
                //对比当前分类
                foreach (DNNGo_DNNGalleryPro_Slider_Group Category in tempCategoryList)
                {
            ...
            {
                DNNGo_DNNGalleryPro_Slider_Group Category = new DNNGo_DNNGalleryPro_Slider_Group();
            ...
            //剩下的ID添加
            foreach (DNNGo_DNNGalleryPro_Slider_Group Category in CategoryList)
            {
        ...
        public static String FindArticleIDsByCategoryIDs(String CategoryIDs)
        {
            ...
            List<DNNGo_DNNGalleryPro_Slider_Group> CategoryList =  FindAll(qp, out RecordCount);
            String ArticleIDs = String.Empty;

            foreach (DNNGo_DNNGalleryPro_Slider_Group ArticleID in CategoryList)
            {
