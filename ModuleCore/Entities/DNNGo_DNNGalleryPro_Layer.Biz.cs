...
namespace DNNGo.Modules.DNNGalleryPro
{
	...
	/// 项(集合)
	/// </summary>
	public partial class DNNGo_DNNGalleryPro_Layer : Entity<DNNGo_DNNGalleryPro_Layer>
	{
		#region 对象操作
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个项(集合)实体对象用于表单编辑
		/// </summary>
		///<param name="__ID">项编号</param>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static DNNGo_DNNGalleryPro_Layer FindByKeyForEdit(Int32 __ID)
		{
			DNNGo_DNNGalleryPro_Layer entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new DNNGo_DNNGalleryPro_Layer();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static DNNGo_DNNGalleryPro_Layer FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
        ...
        /// <returns></returns>
        public static List<DNNGo_DNNGalleryPro_Layer> FindAllBySliderID(Int32 SliderID)
        {
		...
		public static List<DNNGo_DNNGalleryPro_Layer> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
