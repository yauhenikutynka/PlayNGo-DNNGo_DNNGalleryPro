...
namespace DNNGo.Modules.DNNGalleryPro
{
    public class TemplateFormat
    {
        ...
        /// <returns></returns>
        public String ViewContent(String FieldName, DNNGo_DNNGalleryPro_Slider DataItem, Int32 Lenght)
        {
        ...
        /// <returns></returns>
        public String ViewContent(String FieldName, DNNGo_DNNGalleryPro_Slider DataItem, Int32 Lenght, String Suffix)
        {
        ...
        /// <returns></returns>
        public List<DNNGo_DNNGalleryPro_Layer> FindLayers(DNNGo_DNNGalleryPro_Slider DataItem, List<DNNGo_DNNGalleryPro_Layer> Layers)
        {
        ...
        {
            return FullPortalUrl(Globals.NavigateURL(bpm.Settings_TabID, bpm.PortalSettings, "", String.Format("Token{0}=Info", bpm.Settings_ModuleID), String.Format("SliderID{0}={1}", bpm.Settings_ModuleID, SliderID)));
        }


        public String GoUrl(DNNGo_DNNGalleryPro_Slider SliderItem)
        {
        ...
        /// <returns></returns>
        public String GoUrl(DNNGo_DNNGalleryPro_Group GroupItem)
        {
        ...
        /// <param name="DataItem"></param>
        /// <returns></returns>
        public String GoEditUrl(DNNGo_DNNGalleryPro_Slider DataItem)
        {
        ...
        /// <returns></returns>
        public String GoDownloadUrl(DNNGo_DNNGalleryPro_Layer LayerItem,String SettingName)
        {
        ...
        /// <returns></returns>
        public String GoHeatsUrl(DNNGo_DNNGalleryPro_Layer LayerItem, Int32 Heat)
        {
        ...
        public String PortalUrl
        {
            get
            {
                if (String.IsNullOrEmpty(_PortalUrl))
                {
                    ...
                    {
                        if (!String.IsNullOrEmpty(bpm.DNNGalleryPro_PortalSettings.PortalAlias.HTTPAlias))
                        {
                            _PortalUrl = String.Format("{0}://{1}", bpm.IsSSL ? "https" : "http", bpm.DNNGalleryPro_PortalSettings.PortalAlias.HTTPAlias);
                        }
                    }
                }
                return _PortalUrl;
        ...
        /// <returns></returns>
        public String PictureUrl(DNNGo_DNNGalleryPro_Slider DataItem, String FieldName,String DefaultValue)
        {
        ...
        /// <param name="FieldName"></param>
        /// <returns></returns>
        public String PictureUrl(DNNGo_DNNGalleryPro_Layer DataItem, String FieldName, String DefaultValue)
        {
        ...
        /// <param name="FieldName"></param>
        /// <returns></returns>
        public String PictureSize(DNNGo_DNNGalleryPro_Layer DataItem, String FieldName)
        {
            String _PictureSize = "0kb";
            String _PictureUrl = Convert.ToString(ViewLayerSetting(DataItem, FieldName, ""));
            if (!String.IsNullOrEmpty(_PictureUrl) && _PictureUrl.IndexOf("MediaID=", StringComparison.CurrentCultureIgnoreCase) >= 0)
        ...
        /// <returns></returns>
        public String ThumbnailUrl(DNNGo_DNNGalleryPro_Slider DataItem, object width, object height, object mode, string phototype = "p")
        {
        ...
        /// <param name="DefaultValue">默认值</param>
        /// <returns></returns>
        public object ViewCategorySetting(DNNGo_DNNGalleryPro_Group DataItem, String Name, object DefaultValue)
        {
        ...
        /// <param name="DefaultValue">默认值</param>
        /// <returns></returns>
        public T ViewCategorySettingT<T>(DNNGo_DNNGalleryPro_Group DataItem, String Name, object DefaultValue)
        {
        ...
        /// <param name="DefaultValue">默认值</param>
        /// <returns></returns>
        public static object ViewCategorySettingByStatic(DNNGo_DNNGalleryPro_Group DataItem, String Name, object DefaultValue)
        {
        ...
        /// <returns></returns>
        public Boolean IsIncludeGroup(DNNGo_DNNGalleryPro_Slider DataItem, Int32 GroupID)
        {
        ...
        /// 是否DNN920以上
        /// </summary>
        public Boolean IsDNN920
        {
            get { return Common.CompareVersion("09.02.00", Globals.DataBaseVersion.ToString()); }
        }
