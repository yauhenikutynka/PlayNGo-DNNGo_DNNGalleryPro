...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public class BaseModule : PortalModuleBase
    {
        ...
        {
            get { return Settings_CopyOfOtherModule ? (Settings["DNNGalleryPro_ModuleID"] != null ? Convert.ToInt32(Settings["DNNGalleryPro_ModuleID"]) : ModuleId) : ModuleId; }
        }
        ...
        {
            get { return Settings_CopyOfOtherModule ? (Settings["DNNGalleryPro_TabID"] != null ? Convert.ToInt32(Settings["DNNGalleryPro_TabID"]) : TabId):TabId; }
        }
        ...
        {
            get { return Settings_CopyOfOtherModule ? (Settings["DNNGalleryPro_CopyOfPortal"] != null ? Convert.ToInt32(Settings["DNNGalleryPro_CopyOfPortal"]) : PortalId) : PortalId; }
        }
        ...
        public TabInfo Settings_TabInfo
        {
            get
            {
                ...
                {
                    _Settings_TabInfo = new TabController().GetTab(Settings_TabID, Settings_PortalID, true);
                }
        ...
        {
            get { return Settings["DNNGalleryPro_Sortby"] != null ? Convert.ToInt32(Settings["DNNGalleryPro_Sortby"]) : 0; }
        }

        private PortalSettings _DNNGalleryPro_PortalSettings = new PortalSettings();
        /// <summary>
        /// 获取站点配置
        /// </summary>
        public PortalSettings DNNGalleryPro_PortalSettings
        {
            get
            {
                if (!(_DNNGalleryPro_PortalSettings != null && _DNNGalleryPro_PortalSettings.PortalId > 0))
                {
                    if (Settings_CopyOfOtherModule && Settings_ModuleID != ModuleId)
                    {
                        _DNNGalleryPro_PortalSettings = new PortalSettings(Settings_PortalID);
                        ...
                        {
                            _DNNGalleryPro_PortalSettings.PortalAlias = (PortalAliasInfo)PortalAlias[0];
                        }else
                        {

                            _DNNGalleryPro_PortalSettings.PortalAlias = new PortalAliasInfo();
                            _DNNGalleryPro_PortalSettings.PortalAlias.PortalID = Settings_PortalID;
                        }
                    ...
                    {
                        _DNNGalleryPro_PortalSettings = PortalController.GetCurrentPortalSettings();
                    }
                }
                return _DNNGalleryPro_PortalSettings;
            }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_CopyOfOtherModule"] != null ? Convert.ToBoolean(Settings["DNNGalleryPro_CopyOfOtherModule"]) : false; }
        }
        ...
        {
            get { return WebHelper.GetIntParam(HttpContext.Current.Request, String.Format("GroupID{0}", ModuleId), 0); }
        }
        ...
        {
            get { return WebHelper.GetIntParam(HttpContext.Current.Request, String.Format("Attribute1_{0}", ModuleId), -1); }
        }
        ...
        {
            get { return WebHelper.GetStringParam(HttpContext.Current.Request, String.Format("Attribute2_{0}", ModuleId), ""); }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_EffectName"] != null ? Convert.ToString(Settings["DNNGalleryPro_EffectName"]) : GetDefaultEffectName(); }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_EffectThemeName"] != null ? Convert.ToString(Settings["DNNGalleryPro_EffectThemeName"]) : GetDefaultThemeName(); }
        }
        ...
        public List<SettingEntity> Setting_LayerSettingDB
        {
            get
            {
                ...
                {
                    String LayerSettingDBPath = Server.MapPath(String.Format("{0}Effects/{1}/LayerSetting.xml", ModulePath, Settings_EffectName));
        ...
        {
            get { return Settings["DNNGalleryPro_jQuery_Enable"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryPro_jQuery_Enable"].ToString()) ? Convert.ToBoolean(Settings["DNNGalleryPro_jQuery_Enable"]) : false; }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_jQuery_UseHosted"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryPro_jQuery_UseHosted"].ToString()) ? Convert.ToBoolean(Settings["DNNGalleryPro_jQuery_UseHosted"]) : false; }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_jQuery_HostedjQuery"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryPro_jQuery_HostedjQuery"].ToString()) ? Convert.ToString(Settings["DNNGalleryPro_jQuery_HostedjQuery"]) : "https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"; }
        }
        ...
        {
            get { return Settings["DNNGalleryPro_jQuery_HostedjQueryUI"] != null && !string.IsNullOrEmpty(Settings["DNNGalleryPro_jQuery_HostedjQueryUI"].ToString()) ? Convert.ToString(Settings["DNNGalleryPro_jQuery_HostedjQueryUI"]) : "https://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js"; }
        }
        ...
        public void BindXmlDBToPage(EffectDBEntity XmlDB, String XmlName)
        {
            ...
            {
                List<String> GlobalScripts = Common.GetList(XmlDB.GlobalScript);
            ...
            {
                List<String> EffectScripts = Common.GetList(XmlDB.EffectScript);
        ...
        public void LoadViewScript()
        {
            ...
            if ((objCSS != null))
            {
                ...
                if (IsEdit)//管理员时需要相关的CSS
                {
                    BindStyleFile("Modules.css", String.Format("{0}Resource/css/Modules.css", ModulePath));
                }
        ...
        public void LoadManagerScript()
        {
            ...
            if ((objCSS != null))
            {
                ...
                if (HttpContext.Current.Items["DNNGo_DNNGalleryPro_Modules_css"] == null)
                {
                    Literal litLink = new Literal();
                    litLink.Text = "<link  rel=\"stylesheet\" type=\"text/css\" href=\"" + ModulePath + "Resource/css/Modules.css\" />";

                    HttpContext.Current.Items.Add("DNNGo_DNNGalleryPro_Modules_css", "true");
                    objCSS.Controls.Add(litLink);
                }
                ...
                if (HttpContext.Current.Items["Vanadium_js"] == null)
                {
                    ...
                    Page.ClientScript.RegisterClientScriptInclude("Vanadium_js", String.Format("{0}Resource/js/vanadium.js?cdv={1}", ModulePath, CrmVersion));
                }
                ...
                if (HttpContext.Current.Items["jquery.validationEngine-en_js"] == null)
                {
                    //Literal litLink = new Literal();
                    //litLink.Text =
                    //     Microsoft.VisualBasic.Constants.vbCrLf + "<script type=\"text/javascript\" src=\"" + ModulePath + "Resource/js/jquery.validationEngine-en.js\"></script>" +
                    //    Microsoft.VisualBasic.Constants.vbCrLf;
                    ...
                    HttpContext.Current.Items.Add("jquery.validationEngine-en_js", "true");
                    DotNetNuke.Framework.AJAX.AddScriptManager(this.Page);
                    Page.ClientScript.RegisterClientScriptInclude("jquery.validationEngine-en_js", ViewValidationEngineLanguage());
                }
                ...
                if (HttpContext.Current.Items["validationEngine_js"] == null)
                {
                    ...
                    DotNetNuke.Framework.AJAX.AddScriptManager(this.Page);
                    Page.ClientScript.RegisterClientScriptInclude("validationEngine_js", String.Format("{0}Resource/js/jquery.validationEngine.js?cdv={1}", ModulePath,CrmVersion));
                }

                if (HttpContext.Current.Items["xheditor-1.2.1.min.js"] == null)
                {
                    HttpContext.Current.Items.Add("xheditor-1.2.1.min.js", "true");
                    DotNetNuke.Framework.AJAX.AddScriptManager(this.Page);
                    Page.ClientScript.RegisterClientScriptInclude("xheditor-1.2.1.min.js", String.Format("{0}Resource/js/xheditor/xheditor-1.2.1.min.js?cdv={1}", ModulePath, CrmVersion));
                }
        ...
        public object ViewXmlSetting(String Name, object DefaultValue)
        {
            ...
            return Settings[SettingKey] != null ? Convert.ChangeType(Settings[SettingKey], DefaultValue.GetType()) : DefaultValue;
        }
        ...
        /// <param name="DefaultValue">默认值</param>
        /// <returns></returns>
        public object ViewLayerSetting(DNNGo_DNNGalleryPro_Layer DataItem, String Name, object DefaultValue)
        {
            object o = DefaultValue;
            if (DataItem != null && DataItem.ID > 0 && !String.IsNullOrEmpty(DataItem.Options))
            {
        ...
        /// <param name="DefaultValue">默认值</param>
        /// <returns></returns>
        public T ViewLayerSettingT<T>(DNNGo_DNNGalleryPro_Layer DataItem, String Name, T DefaultValue)
        {
        ...
        {
            return String.Format("{0}{1}", DNNGalleryPro_PortalSettings.HomeDirectory, FilePath);
        }
        ...
        public String GetDefaultEffectName()
        {
            ...
            {
               UpdateModuleSetting("DNNGalleryPro_EffectName", EffectDirs[0].Name);
        ...
        public String GetDefaultThemeName()
        {
            ...
            {
                UpdateModuleSetting("DNNGalleryPro_EffectThemeName", ThemeDirs[0].Name);
