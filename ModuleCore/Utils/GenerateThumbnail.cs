...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public class GenerateThumbnail
    {
        ...
        {
            WebClientX xx = new WebClientX();
            System.Drawing.Image originalImage =  new Bitmap(width,height);
            ...
            try
            {
                ...
                if (fi.Exists)
                {
                    originalImage = System.Drawing.Image.FromStream(fi.OpenRead());
                }
                else
                {
                    originalImage = Image.FromStream(xx.OpenRead(originalImagePath));
                }
            }
            catch
            {
