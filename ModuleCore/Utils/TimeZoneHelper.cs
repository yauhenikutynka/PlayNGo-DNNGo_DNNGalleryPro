...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    public class TimeZoneHelper
    {
        ...
        public static TimeZoneInformation GetTimeZone()
        {
            ...
            bool result = TimeZone.CurrentTimeZone.IsDaylightSavingTime(DateTime.Now);
            if (result == false || tzi.daylightBias == 0)
            {
                tzi.activeTimeBias = tzi.bias;
            }
            else
            {
                tzi.activeTimeBias = tzi.bias + tzi.daylightBias;
            }
