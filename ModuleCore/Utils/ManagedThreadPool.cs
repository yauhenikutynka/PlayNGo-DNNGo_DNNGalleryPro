...
namespace DNNGo.Modules.DNNGalleryPro
{
    ...
    /// <remarks>winner2050 2010.5.4泛型优化。</remarks>
    ...
    public class ManagedThreadPool
    {
        ...
        private static Queue<WaitingCallback> _waitingCallbacks;
        /// <summary>
        ...
        private static List<Thread> _workerThreads;
        ...
        private static void Initialize()
        {
            ...
            _waitingCallbacks = new Queue<WaitingCallback>();
            ...
            for (int i = 0; i < _maxWorkerThreads; i++)
            {
                ...
                newThread.Name = string.Concat("ManagedPoolThread #", i);
                ...
                try
                {
                    ...
                    foreach (WaitingCallback callback in _waitingCallbacks)
                    {
                        if (callback.State is IDisposable)
                            (callback.State as IDisposable).Dispose();
                    }
                }
                catch { }
        ...
        private static void ProcessQueuedItems()
        {
            ...
            while (true)
            {
                ...
                lock (_poolLock)
                {
                    ...
                    {
                        try { callback = _waitingCallbacks.Dequeue(); }
