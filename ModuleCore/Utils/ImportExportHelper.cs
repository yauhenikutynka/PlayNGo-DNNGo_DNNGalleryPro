    ...
    public class ImportExportHelper
    {
        ...
        public PortalSettings DNNGalleryPro_PortalSettings
        {
            get
            {
                if (!(_DNNGalleryPro_PortalSettings != null && _DNNGalleryPro_PortalSettings.PortalId > 0))
                {
                    ...
                    _DNNGalleryPro_PortalSettings = new PortalSettings(portalInfo.PortalID);
                        ...
                        else
                        {
                            ...
                            _DNNGalleryPro_PortalSettings.PortalAlias.PortalID = portalInfo.PortalID;
                        }
                }
        ...
        public Hashtable DNNGalleryPro_Settings
        {
            get
            {
                ...
                {
                    _DNNGalleryPro_Settings = new ModuleController().GetModule(ModuleID).ModuleSettings;
                }
        ...
        public String ModulePath
        {
            get {
                if (String.IsNullOrEmpty(_ModulePath))
                {
                    ...
                    _ModulePath = "~/DesktopModules/DNNGo_DNNGalleryPro/";
        ...
        {
            get { return DNNGalleryPro_Settings["DNNGalleryPro_EffectName"] != null ? Convert.ToString(DNNGalleryPro_Settings["DNNGalleryPro_EffectName"]) : "Effect_01_AnythingSlider"; }
        }
