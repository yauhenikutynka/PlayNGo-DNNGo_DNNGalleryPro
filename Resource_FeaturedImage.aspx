<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resource_FeaturedImage.aspx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Resource_FeaturedImage1" %>
<%@ Register src="Resource_DropzoneUpload.ascx" tagname="Resource_DropzoneUpload" tagprefix="uc1" %>
<%@ Register src="Resource_FeaturedImage.ascx" tagname="Resource_FeaturedImage" tagprefix="uc2" %>
<!DOCTYPE HTML>
<!--
/*
