...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class Setting_ManagerLists : BaseModule
    {
        ...
        /// 排序字段
        /// </summary>
        public string Orderfld = WebHelper.GetStringParam(HttpContext.Current.Request, "sort_f", DNNGo_DNNGalleryPro_Slider._.Sort);
        ...
        private void BindDataList()
        {
            ...
            List<DNNGo_DNNGalleryPro_Slider> Articles = DNNGo_DNNGalleryPro_Slider.FindAll(qp, out RecordCount);
            ...
            hlAllArticle.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Slider.FindCountByStatus(Settings_ModuleID, -1), ViewResourceText("hlAllArticle", "All"));
            hlActivatedArticle.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Slider.FindCountByStatus(Settings_ModuleID, (Int32)EnumStatus.Activated), ViewResourceText("hlActivatedArticle", "Activated"));
            hlHiddenArticle.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Slider.FindCountByStatus(Settings_ModuleID, (Int32)EnumStatus.Hidden), ViewResourceText("hlHiddenArticle", "Hidden"));
            hlRecycleBinArticle.Text = String.Format("{1} ({0})", DNNGo_DNNGalleryPro_Slider.FindCountByStatus(Settings_ModuleID, (Int32)EnumStatus.RecycleBin), ViewResourceText("hlRecycleBinArticle", "Recycle Bin"));
            ...
            BindGridViewEmpty<DNNGo_DNNGalleryPro_Slider>(gvArticleList, new DNNGo_DNNGalleryPro_Slider());
