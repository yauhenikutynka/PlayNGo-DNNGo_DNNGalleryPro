        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                if ((ddlModule.Items.Count > 0))
                {
                    ...
                    if (values.Length == 2)
                    {
                        objModuleController.UpdateModuleSetting(this.ModuleId, "DNNGalleryPro_TabID", values[0]);
                        objModuleController.UpdateModuleSetting(this.ModuleId, "DNNGalleryPro_ModuleID", values[1]);
                    }
                }
            }
            catch (Exception ex)
