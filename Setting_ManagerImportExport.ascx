<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_ManagerImportExport.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Setting_ManagerImportExport" %>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="form-horizontal">
                     <div class="form-group">
                        <%=ViewControlTitle("lblImportFormXml", "Import From Xml", "fuImportFormXml", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-4">
