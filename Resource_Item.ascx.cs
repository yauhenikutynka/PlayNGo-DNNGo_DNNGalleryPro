...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class Resource_Item : BaseModule
    {
        ...
        private DNNGo_DNNGalleryPro_Layer _LayerItem;
        /// <Description>
        /// 层
        /// </Description>
        public DNNGo_DNNGalleryPro_Layer LayerItem
        {
            get
            {
                ...
                {
                    if (LayerID > 0)
                        _LayerItem = DNNGo_DNNGalleryPro_Layer.FindByKeyForEdit(LayerID);
                    else
                        _LayerItem = new DNNGo_DNNGalleryPro_Layer();
                }
                return _LayerItem;
            }
        }
      ...
      || (!String.IsNullOrEmpty(LayerType) && r.Layout.IndexOf(LayerType, StringComparison.CurrentCultureIgnoreCase) >= 0));
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               DNNGo_DNNGalleryPro_Layer Layer =SetDataItem();
