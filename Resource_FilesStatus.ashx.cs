...
namespace DNNGo.Modules.DNNGalleryPro {
	public class Resource_FilesStatus {
        ...
        public Resource_FilesStatus(DNNGo_DNNGalleryPro_Files PhotoItem, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, PhotoItem.FileSize, ps, ModulePath); }

        public Resource_FilesStatus(DNNGo_DNNGalleryPro_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, fileLength, ps, ModulePath); }

        private void SetValues(DNNGo_DNNGalleryPro_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath)
        {
        ...
        public String ViewPicture(DNNGo_DNNGalleryPro_Files DataItem, PortalSettings ps, String ModulePath)
        {
        ...
        public String ThumbnailUrl(DNNGo_DNNGalleryPro_Files DataItem, PortalSettings ps, String ModulePath)
        {
        ...
        /// <returns></returns>
        public String GetPhotoPath(DNNGo_DNNGalleryPro_Files media, PortalSettings ps)
        {
        ...
        private String GetPhotoExtension(String FileExtension, String FilePath, PortalSettings ps, String ModulePath)
        {
            ...
            if (FileExtension == "jpg")
                ...
                return GetFileIcon("video.jpg", ModulePath);
            else if (FileExtension == "ogv")
                return GetFileIcon("video.jpg", ModulePath);
            else if (FileExtension == "webm")
                return GetFileIcon("video.jpg", ModulePath);
            else if (FileExtension == "mp3")
                return GetFileIcon("audio.jpg", ModulePath);
            else if (FileExtension == "wma")
                return GetFileIcon("audio.jpg", ModulePath);
            else if (FileExtension == "zip")
                return GetFileIcon("zip.jpg", ModulePath);
            else if (FileExtension == "rar")
                return GetFileIcon("zip.jpg", ModulePath);
            else if (FileExtension == "7z")
                return GetFileIcon("zip.jpg", ModulePath);
            else if (FileExtension == "xls")
                return GetFileIcon("Document.jpg", ModulePath);
            else if (FileExtension == "txt")
                return GetFileIcon("text.jpg", ModulePath);
            else if (FileExtension == "cs")
                return GetFileIcon("code.jpg", ModulePath);
            else if (FileExtension == "html")
                return GetFileIcon("code.jpg", ModulePath);
            else if (FileExtension == "pdf")
                return GetFileIcon("pdf.jpg", ModulePath);
            else if (FileExtension == "doc")
                return GetFileIcon("Document.jpg", ModulePath);
            else if (FileExtension == "docx")
                return GetFileIcon("Document.jpg", ModulePath);
            else
                return GetFileIcon("Unknown type.jpg", ModulePath);
        }
