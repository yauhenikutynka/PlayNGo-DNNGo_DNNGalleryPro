<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="~/Resource_RichUrls.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Resource_RichUrls" %>
			 <div class="Controls_Urls" data-name="<%=ClientName %>" data-default="<%=ShowDefault %>"  data-rtbox="false">
