...
namespace DNNGo.Modules.DNNGalleryPro
{
    public partial class View_List : BaseModule 
    {
        ...
        {
            get { return Settings["DNNGalleryPro_FilterStartTime"] != null  ? Convert.ToBoolean(Settings["DNNGalleryPro_FilterStartTime"]) : true; }
        }
        /// <summary>
        /// 需要筛选结束时间
        /// </summary>
        ...
        {
            get { return Settings["DNNGalleryPro_FilterEndTime"] != null  ? Convert.ToBoolean(Settings["DNNGalleryPro_FilterEndTime"]) : true; }
        }
