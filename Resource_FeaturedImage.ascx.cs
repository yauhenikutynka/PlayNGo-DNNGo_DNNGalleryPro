...
{
    public partial class Resource_FeaturedImage : BaseModule
    {
        ...
        public String CurrentUrl
        {
            get
            {
                ...
                sb.AppendFormat("{0}?PortalId={1}&TabId={2}&ModuleId={3}&language={4}&Insert={5}&FileType={6}", "Resource_FeaturedImage.aspx", PortalId, TabId, ModuleId, language, InsertType, File_Type);
        ...
        private void BindDataList()
        {
            ...
            List<DNNGo_DNNGalleryPro_Files> Articles = DNNGo_DNNGalleryPro_Files.FindAll(qp, out RecordCount);
            ...
            BindGridViewEmpty<DNNGo_DNNGalleryPro_Files>(gvArticleList, new DNNGo_DNNGalleryPro_Files());
        }
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            Where.Add(new SearchParam(DNNGo_DNNGalleryPro_Files._.PortalId, Settings_PortalID, SearchType.Equal));
            Where.Add(new SearchParam(DNNGo_DNNGalleryPro_Files._.FileExtension, "'jpg','jpeg','gif','png','bmp'", SearchType.In));

            //筛选文章的状态
            if (ArticleStatus >= 0)
            {
                Where.Add(new SearchParam(DNNGo_DNNGalleryPro_Files._.Status, ArticleStatus, SearchType.Equal));
            }
