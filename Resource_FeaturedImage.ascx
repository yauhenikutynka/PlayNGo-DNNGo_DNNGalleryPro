<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_FeaturedImage.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryPro.Resource_FeaturedImage" %>
    <div class="row">
        <div class="col-sm-8">
      ...
      <!-- end--> 
            ...
            <script type="text/javascript">
                ...
                function Return<%=File_Type %>(PictureUrl, PictureID) {
                    window.parent.Show<%=File_Type %>(PictureUrl, PictureID);
                    window.parent.$('#UrlLink_Modal').modal('hide');
                }
